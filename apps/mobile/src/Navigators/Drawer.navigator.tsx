...
import ListOrdersScreen from "../Entities/Orders/List.orders.screen";
import ShowOrdersScreen from "../Entities/Orders/Show.orders.screen";
    ...
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
          ...
          />
          <Stack.Screen
          name="ShowOrdersScreen"
          component={ShowOrdersScreen}
          options={screenOptions}
        />
